            ...
            AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: selectedAnswer == correctIndex
                    ...
                    : AppTheme.rougeFrance.withOpacity(0.06),
                borderRadius: BorderRadius.circular(12),
                border: Border.all(
                  color: selectedAnswer == correctIndex
                      ? AppTheme.successColor.withOpacity(0.3)
                      : AppTheme.rougeFrance.withOpacity(0.3),
                ),
              ),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget build(BuildContext context) {
    ...
    if (answered) {
      if (isCorrect) {
        ...
        bgColor = AppTheme.rougeFrance.withOpacity(0.08);
        borderColor = AppTheme.rougeFrance;
        textColor = AppTheme.rougeFrance;
      }
    } else if (isSelected) {
      bgColor = AppTheme.bleuFrance.withOpacity(0.08);
      borderColor = AppTheme.bleuFrance;
    }
              ...
              Expanded(
                child: OutlinedButton(
                  ...
                  style: OutlinedButton.styleFrom(
                    ...
                    side: const BorderSide(color: AppTheme.bleuFrance, width: 2),
                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(50)),
                  ),
                  child: Text(
                    lang.t('quiz_retry'),
                    style: const TextStyle(fontWeight: FontWeight.w700, color: AppTheme.bleuFrance),
                  ),
                ),
              ),
              const SizedBox(width: 12),
